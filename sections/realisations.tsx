...
import {
  ContributionMap,
  ESPORT_MATCHING_SCORE,
  LocalAiNote,
  MatchingScoreGraphic,
  PipelineGraphic,
  RB_TKTS_PIPELINE,
      ...
      <div className="mx-auto max-w-6xl space-y-16">
        ...
        <article id="projet-ticket-tool" className="grid gap-8 border-b border-border/50 pb-12 md:grid-cols-[220px_1fr]">
          ...
          <div className="space-y-6">
            ...
            <PipelineGraphic title="Pipeline RB_TKTS" steps={RB_TKTS_PIPELINE} />
            <p className="text-foreground/85 leading-relaxed">
            ...
            <div className="space-y-2">
              ...
              <ContributionMap items={TICKET_PERSONAL_WORK} />
            </div>
        ...
        <article id="projet-2" className="grid gap-8 md:grid-cols-[220px_1fr]">
          ...
          <div className="space-y-6">
            ...
            <MatchingScoreGraphic items={ESPORT_MATCHING_SCORE} />
            <p className="text-foreground/85 leading-relaxed">
            ...
            <div className="space-y-2">
              <p className="text-xs uppercase tracking-[0.16em] text-muted-foreground">Ce que j'ai codé personnellement</p>
              <ContributionMap items={API_PERSONAL_WORK} />
            </div>
