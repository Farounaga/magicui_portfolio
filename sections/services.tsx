    ...
    return (
        <section>
            <Parallax className="min-h-[100rem] py-8 px-6">
                <div className='sticky z-10 top-0 h-screen space-y-4 w-full flex flex-col justify-center items-center text-center'>
                    <h1 
                    onClick={() => document.getElementById("presentation")?.scrollIntoView({ behavior: "smooth" })}
                    className="cursor-pointer text-4xl md:text-6xl lg:text-7xl font-bold uppercase tracking-tight text-foreground/90 hover:text-foreground">
                        Présentation
                    </h1>
                    <h1
