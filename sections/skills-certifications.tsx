...
const SKILL_GROUPS: SkillGroups = {
  ...
  frontend: [
    ...
    { name: "TypeScript", level: 20, note: "Typage progressif pour des composants plus robustes.", icon: Code2 },
    { name: "Tailwind CSS", level: 20, note: "UI moderne utilitaire et prototypage rapide.", icon: Braces },
    { name: "Next.js", level: 18, note: "Pages, sections interactives et intégration App Router.", icon: Workflow },
    { name: "Bootstrap", level: 15, note: "Composants rapides pour prototypage.", icon: Workflow },
    { name: "Vite", level: 14, note: "Bundler léger pour projets front rapides.", icon: Cpu },
    { name: "ERB (Ruby)", level: 14, note: "Templates frontend côté Rails pour vues dynamiques.", icon: Code2 },
    { name: "Jinja2 (Python)", level: 12, note: "Templates frontend côté Python/Flask, blocs et composants.", icon: Code2 },
    { name: "Astro", level: 10, note: "Bases de sites statiques performants orientés contenu.", icon: Globe },
...
const STACK_MARQUEE: Array<{ label: string; icon: LucideIcon }> = [
  ...
  { label: "Tailwind", icon: Braces },
  { label: "Next.js", icon: Workflow },
  { label: "Vite", icon: Cpu },
  { label: "Astro", icon: Globe },
  { label: "ERB", icon: Code2 },
  { label: "Jinja2", icon: Code2 },
